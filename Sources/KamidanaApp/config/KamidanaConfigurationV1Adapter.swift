...
public enum KamidanaConfigurationV1Adapter {
        ...
        return DisplayLayoutConfig(
            ...
            left: left.compactMap {
                makeWidget(
                    ...
                    sectionPopupStyle: mergedStyle(
                        globalPopupStyle, leftPopupStyle ?? KamidanaStyle()),
            ...
            center: orderedCenter.compactMap {
                makeWidget(
                    ...
                    sectionPopupStyle: mergedStyle(
                        globalPopupStyle, centerPopupStyle ?? KamidanaStyle()),
            ...
            right: right.compactMap {
                makeWidget(
                    ...
                    sectionPopupStyle: mergedStyle(
                        globalPopupStyle, rightPopupStyle ?? KamidanaStyle()),
                    displayFormat: $0.format,
    ...
    private static func makeWidget(
        ...
        let resolvedPopupTheme = resolveTheme(
            style: popupStyle, colors: colors, isPopup: true, compact: compact)
        ...
        case .audioVisualizer:
            ...
            let audioVisualizerConfig = AudioVisualizerWidgetConfig(
                format: format,
        ...
        case .weather:
            return WidgetInstance(
                ...
                config: WeatherWidgetConfig(
                    ...
                    display: widget.weatherDisplay ?? WeatherDisplayConfig(), lang: language
                ),
                id: widget.id,
                v1Style: style, v1PopupStyle: popupStyle,
                v1Format: displayFormat,
    ...
    private static func applyGlobalStyle(
        _ style: KamidanaStyle, to colors: inout GlobalColorsConfig
    ) {
