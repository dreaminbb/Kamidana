...
struct SmoothUIModuleModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        ...
        let leadingPadding = padding?.leading ?? style.paddingHorizontal
        let trailingPadding = padding?.trailing ?? style.paddingHorizontal
        ...
        let transition: Animation? = {
            ...
            case .easeInOut: return .easeInOut(duration: effectiveStyle?.animation?.durationSeconds ?? 0.2)
